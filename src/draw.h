/* $Id: draw.h,v 1.11 1996/05/01 20:46:01 brianp Exp $ */
...
/*
$Log: draw.h,v $
 * Revision 1.11  1996/05/01  20:46:01  brianp
 * added GL_MESA_window_pos extension code
 *
 * Revision 1.10  1996/04/23  22:05:12  brianp
 * removed gl_execute_vertex() and added gl_nop_vertex()
 *
...
extern void gl_nop_vertex( GLfloat x, GLfloat y, GLfloat z, GLfloat w );
...
extern void gl_windowpos( GLfloat x, GLfloat y, GLfloat z, GLfloat w );
