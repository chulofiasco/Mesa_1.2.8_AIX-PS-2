/* $Id: quadric.c,v 1.17 1996/03/05 15:34:36 brianp Exp $ */
...
/*
$Log: quadric.c,v $
 * Revision 1.17  1996/03/05  15:34:36  brianp
 * added Michael Pichler's March 5th texture coordinate patches
 *
 * Revision 1.16  1996/02/13  17:45:47  brianp
 * fixed texture coordinate bug in gluSphere()
 *
 * Revision 1.15  1996/02/07  15:55:37  brianp
 * removed all glEn/Disable() calls, caused display list problems
 * make gluCylinder() generate unit-length normals
 *
 * Revision 1.14  1996/02/07  15:51:35  brianp
 * added texture coordinate generation contributed by Martin Bernhard
 *
 * Revision 1.13  1995/12/12  21:33:36  brianp
