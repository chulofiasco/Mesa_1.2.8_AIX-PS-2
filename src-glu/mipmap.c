...
/*
$Id: mipmap.c,v 1.11 1996/05/15 15:39:16 brianp Exp $

$Log: mipmap.c,v $
 * Revision 1.11  1996/05/15  15:39:16  brianp
 * changed some return types from int to GLint
 *
 * Revision 1.10  1995/07/25  16:35:17  brianp
 * malloc larger image in gluBuild2DMipmaps() to compensate for alignment
 *
 * Revision 1.9  1995/06/16  14:04:24  brianp
 * gluBuild2DMipmaps: fixed wrong size malloc, better error checking
 *
 ...
 *
 * Revision 1.6  1995/03/17  20:14:02  brianp
 * implemented gluScaleImage and gluBuild2DMipmaps
 *
 * Revision 1.5  1995/03/09  14:51:09  brianp
 * changed log_2 to ilog2
 *
 * Revision 1.4  1995/03/07  19:39:16  brianp
 * changed log2 to log_2
 *
 * Revision 1.3  1995/03/07  14:36:40  brianp
 * first attempt at gluBuild1DMipmaps
 *
