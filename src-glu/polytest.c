...
/*
$Id: polytest.c,v 1.7 1995/09/05 17:46:20 brianp Exp $

$Log: polytest.c,v $
 * Revision 1.7  1995/09/05  17:46:20  brianp
 * removed extraneous & from qsort() call
 *
 * Revision 1.6  1995/08/04  13:09:59  brianp
 * include gluP.h to define NULL, just in case
 *
 * Revision 1.5  1995/07/28  21:35:49  brianp
 * changed all GLUenum to GLenum
 *
 * Revision 1.4  1995/06/09  16:41:07  brianp
 * renamed as polytest.c
 *
 ...
 * Release 1.2
 *
 * Revision 1.1  1995/04/28  16:20:28  brianp
 * Initial revision
 *
 */
